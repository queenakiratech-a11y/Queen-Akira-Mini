...
const ALIVE_IMG = "https://files.catbox.moe/qiboje.jpg"; // Make sure this URL is valid
...
> 🤖 *Status*: *Queen Akira Mini is Alive and Ready!*
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363429835502138@newsletter',
                    newsletterName: 'ᴀᴋɪʀᴀ ᴛᴇᴄʜ',
                    serverMessageId: 143
                }
            }
        }, { quoted: fakevCard });
